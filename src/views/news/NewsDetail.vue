    ...
    <div class="mt-4" id="layoutSidenav_content"  v-if="tabSelected != 'updateNews'">
      <div class="card card_" style="width: 38rem;">
        <img
          ...
          v-bind:src="'petadoption.j.layershift.co.uk/news/avatar/' + news.avatar"
          :alt="news.avatar"
        />
        <div class="card-body">
    ...
    <div id="layoutSidenav_content" class="mt-4">
      <div class="card card_" style="width: 38rem;">
       <input type="file" @change="uploadFiles" style="display:none" ref="getImage"  class="form-control" />
        ...
        <img class="card-img-top img_noCircle" v-else-if="!url"  :src="'https://petadoption.j.layershift.co.uk/news/avatar/' + news.avatar" :alt="news.avatar" />
...
export default {
  ...
  methods: {
    ...
    uploadFiles(event) {
      ...
      const uRL = "petadoption.j.layershift.co.uk/admin/news/avatar/";

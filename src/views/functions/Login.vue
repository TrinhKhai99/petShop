<template>
<div>
  <span class="backToHome" @click="backToHome"><i class="fas fa-arrow-left"> Trang Chủ</i></span>
  <div>
    <div class="panda">
      <div class="ear"></div>
      <div class="face">
    ...
    <form @submit.prevent="login">
      ...
      <div class="form-group">
        <input id="password" type="password" v-model="form.password" required="required" class="form-control" />
